...
class ControllerReportSaleOrder extends Controller {
	public function index() {
		...
		if (isset($this->request->get['filter_group'])) {
			$filter_group = trim($this->request->get['filter_group']);
		} else {
			$filter_group = 'week';
		}

		if (isset($this->request->get['filter_order_status_id'])) {
			$filter_order_status_id = trim($this->request->get['filter_order_status_id']);
		} else {
		...
		if (isset($this->request->get['filter_ext_aff_id'])) {
			$url .= '&filter_ext_aff_id=' . $this->request->get['filter_ext_aff_id'];
		}
		...
		foreach ($results as $result) {
			...
			$credit = $result['gross'] - ( abs($result['discount']) + abs($result['net']) );
			...
			$data['orders'][] = array(
				...
				'net'        => $this->currency->format($result['net'], $this->config->get('config_currency')),
			);
		...
		$data['column_gross'] = $this->language->get('column_gross');
		$data['column_discount'] = $this->language->get('column_discount');
		$data['column_net'] = $this->language->get('column_net');
		...
		$data['entry_ext_aff_id'] = $this->language->get('entry_ext_aff_id');
