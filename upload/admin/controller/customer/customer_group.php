...
class ControllerCustomerCustomerGroup extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['customer_groups'][] = array(
				...
				'edit'              => $this->url->link('customer/customer_group/edit', $url . '&customer_group_id=' . $result['customer_group_id'], true)
			);
		}
		...
		$data['sort_name']       = $this->url->link('customer/customer_group', $url . '&sort=cgd.name', true);
		$data['sort_sort_order'] = $this->url->link('customer/customer_group', $url . '&sort=cg.sort_order', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['customer_group_id'])) {
			...
			$data['action'] = $this->url->link('customer/customer_group/edit', $url . '&customer_group_id=' . $this->request->get['customer_group_id'], true);
		}
		...
		if (isset($this->request->post['discount'])) {
			...
			$data['discount'] = $customer_group_info['discount'];
		} else {
			$data['discount'] = '';
		}
