...
class ControllerModuleCustomer extends Controller {
	...
	public function index() {
		$this->load->language('module/customer');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/customer', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('module/customer', 'token=' . $this->session->data['token'], true);
