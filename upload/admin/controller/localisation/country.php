...
class ControllerLocalisationCountry extends Controller {
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $country_id) {
			...
			$customer_total = $this->model_customer_customer->getTotalCustomersByCountryId($country_id);

			if ($customer_total) {
				$this->error['warning'] = sprintf($this->language->get('error_customer'), $customer_total);
			}

			$affiliate_total = $this->model_affiliate_affiliate->getTotalAffiliatesByCountryId($country_id);
