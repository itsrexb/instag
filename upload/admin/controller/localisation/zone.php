...
class ControllerLocalisationZone extends Controller {
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $zone_id) {
			...
			$customer_total = $this->model_customer_customer->getTotalCustomersByZoneId($zone_id);

			if ($customer_total) {
				$this->error['warning'] = sprintf($this->language->get('error_customer'), $customer_total);
			}

			$affiliate_total = $this->model_affiliate_affiliate->getTotalAffiliatesByZoneId($zone_id);
