              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    <a href="<?php echo $sort_group_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_group_name; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_group_name; ?>"><?php echo $column_group_name; ?></a>
                    <?php } ?></td>                     
