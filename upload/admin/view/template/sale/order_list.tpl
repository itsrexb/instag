            ...
            <table class="table table-bordered table-hover multiselect-checkbox">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'status') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'o.recurring_order') { ?>
                    <a href="<?php echo $sort_recurring_order; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_recurring; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_recurring_order; ?>"><?php echo $column_recurring; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $order['recurring_order']; ?></td>
                  <td class="text-right"><?php echo $order['total']; ?></td>
                  <td class="text-left"><?php echo $order['date_added']; ?></td>
                  <td class="text-right">
                    <a href="index.php?route=customer/customer/login&token=<?php echo $token; ?>&customer_id=<?php echo $order['customer_id']; ?>&store_id=0" class="btn btn-info" target="_blank"  data-toggle="tooltip"  title="<?php echo $button_login; ?>" ><i class="fa fa-sign-in"></i></a>
                  <button class="btn btn-info resend-link" data-link="<?php echo $order['resend_link']; ?>" data-toggle="tooltip" title="<?php echo $text_resend; ?>"><i class="fa fa-envelope"></i></button>
