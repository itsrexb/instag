      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-free-checkout" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="moip_status" id="input-status" class="form-control">
                <?php if ($moip_status) { ?>
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-api_token"><?php echo $entry_api_token; ?></label>
            <div class="col-sm-10">
              <input type="text" name="moip_api_token" value="<?php echo $moip_api_token; ?>" placeholder="<?php echo $entry_api_token; ?>" id="input-api_token" class="form-control">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="moip_api_key" value="<?php echo $moip_api_key; ?>" placeholder="<?php echo $entry_api_key; ?>" id="input-api_key" class="form-control">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <textarea name="moip_public_key" rows="10" placeholder="<?php echo $entry_public_key; ?>" id="input-public_key" class="form-control"><?php echo $moip_public_key; ?></textarea>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="moip_environment" id="input-environment" class="form-control">
                <?php if ($moip_environment == 'production') { ?>
                ...
                <?php } ?>
                <?php if ($moip_environment == 'sandbox') { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="moip_transaction_method" id="input-transaction_method" class="form-control">
                <?php if ($moip_transaction_method == 'authorization') { ?>
                ...
                <?php } ?>
                <?php if ($moip_transaction_method == 'capture') { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="moip_order_status_id" id="input-order_status" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <div class="well well-sm" style="height: 150px; overflow: auto;">
                ...
                <div class="checkbox">
                  <label>
                    <?php if (in_array($currency['code'], $moip_currencies)) { ?>
                    <input type="checkbox" name="moip_currencies[]" value="<?php echo $currency['code']; ?>" checked="checked">
                    <?php echo $currency['code']; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="moip_currencies[]" value="<?php echo $currency['code']; ?>">
                    <?php echo $currency['code']; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <?php if ($error_currencies) { ?>
              <div class="text-danger"><?php echo $error_currencies; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="moip_sort_order" value="<?php echo $moip_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort_order" class="form-control">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-debug"><?php echo $entry_debug; ?></label>
            <div class="col-sm-10">
              <select name="moip_debug" id="input-debug" class="form-control">
                <?php if ($moip_debug) { ?>
                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                <option value="0"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
