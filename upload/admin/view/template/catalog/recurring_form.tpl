      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-recurring" class="form-horizontal">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-price_type"><?php echo $entry_price_type; ?></label>
              <div class="col-sm-10">
                <select name="price_type" id="input-price_type" class="form-control">
                  <?php if ($price_type == 'P') { ?>
          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-trial_price_type"><?php echo $entry_trial_price_type; ?></label>
              <div class="col-sm-10">
                <select name="trial_price_type" id="input-trial_price_type" class="form-control">
                  <?php if ($trial_price_type == 'P') { ?>
                  <option value="P" selected="selected"><?php echo $text_percentage; ?></option>
                  <?php } else { ?>
                  <option value="P"><?php echo $text_percentage; ?></option>
                  <?php } ?>
                  <?php if ($trial_price_type == 'F') { ?>
                  <option value="F" selected="selected"><?php echo $text_fixed_amount; ?></option>
                  <?php } else { ?>
                  <option value="F"><?php echo $text_fixed_amount; ?></option>
                  <?php } ?>
