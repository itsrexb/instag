  ...
  <div class="container-fluid">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
		...
		<td class="text-right"><?php echo $column_no_customer; ?></td>
		<td class="text-right"><?php echo $column_no_active_customer; ?></td>
		...
		<td class="text-right"><?php echo $affiliate['total_customers']; ?></td>
		<td class="text-right"><?php echo $affiliate['total_active_customers']; ?></td>
