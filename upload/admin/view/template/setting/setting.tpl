    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
        	<input type="hidden" name="config_stale_meta_data_limit" value="<?php echo $config_stale_meta_data_limit; ?>">
        	<input type="hidden" name="config_instaghive_environment" value="<?php echo $config_instaghive_environment; ?>">
        	<input type="hidden" name="config_instaghive_key" value="<?php echo $config_instaghive_key; ?>">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-local">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="config_timezone" id="input-timezone" class="form-control chosen-select">
                    <?php $optgroup = ''; ?>
                    <?php foreach ($timezones as $timezone) { ?>
                    <?php if ($timezone['group'] != $optgroup) { ?>
                    <?php if ($optgroup) { ?>
                    </optgroup>
                    <?php } ?>
                    <optgroup label="<?php echo $timezone['group']; ?>">
                    <?php $optgroup = $timezone['group']; ?>
                    <?php } ?>
                    <option value="<?php echo $timezone['key']; ?>" <?php echo ($timezone['key'] == $config_timezone ? 'selected="selected"' : ''); ?>><?php echo $timezone['label']; ?></option>
                    <?php } ?>
                    </optgroup>
                  </select>
                </div>
            ...
            <div class="tab-pane" id="tab-option">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-account_terms"><span data-toggle="tooltip" title="<?php echo $help_account_terms; ?>"><?php echo $entry_account_terms; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_account_terms_id" id="input-account_terms" class="form-control">
                      <option value="0"><?php echo $text_none; ?></option>
                      <?php foreach ($informations as $information) { ?>
                      <?php if ($information['information_id'] == $config_account_terms_id) { ?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-account_privacy"><span data-toggle="tooltip" title="<?php echo $help_account_privacy; ?>"><?php echo $entry_account_privacy; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_account_privacy_id" id="input-account_privacy" class="form-control">
                      <option value="0"><?php echo $text_none; ?></option>
                      <?php foreach ($informations as $information) { ?>
                      <?php if ($information['information_id'] == $config_account_privacy_id) { ?>
                      <option value="<?php echo $information['information_id']; ?>" selected="selected"><?php echo $information['title']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $information['information_id']; ?>"><?php echo $information['title']; ?></option>
                      <?php } ?>
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-fraud-status"><span data-toggle="tooltip" title="<?php echo $help_voided_status; ?>"><?php echo $entry_voided_status; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_voided_status_id" id="input-fraud-status" class="form-control">
                      <?php foreach ($order_statuses as $order_status) { ?>
                      <?php if ($order_status['order_status_id'] == $config_voided_status_id) { ?>
                      <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                      <?php } ?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-fraud-status"><span data-toggle="tooltip" title="<?php echo $help_refunded_status; ?>"><?php echo $entry_refunded_status; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_refunded_status_id" id="input-fraud-status" class="form-control">
                      <?php foreach ($order_statuses as $order_status) { ?>
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-affiliate_group_id"><span data-toggle="tooltip" title="<?php echo $help_affiliate_group; ?>"><?php echo $entry_affiliate_group; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_affiliate_group_id" id="input-affiliate_group_id" class="form-control">
                      <option value="0"><?php echo $text_none; ?></option>
                      <?php foreach ($affiliate_groups as $affiliate_group) { ?>
                      <?php if ($affiliate_group['affiliate_group_id'] == $config_affiliate_group_id) { ?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-affiliate_commission_count"><span data-toggle="tooltip" title="<?php echo $help_affiliate_commission_count; ?>"><?php echo $entry_affiliate_commission_count; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_affiliate_commission_count" value="<?php echo $config_affiliate_commission_count; ?>" placeholder="<?php echo $entry_affiliate_commission_count; ?>" id="input-affiliate_commission_count" class="form-control">
                  </div>
                </div>
                <div class="form-group">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-captcha"><span data-toggle="tooltip" title="<?php echo $help_captcha; ?>"><?php echo $entry_captcha; ?></span></label>
                  <div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-image">
              <div class="form-group">
                ...
                <div class="col-sm-10"><a href="" id="thumb-logo" data-toggle="image" class="img-thumbnail"><img src="<?php echo $logo; ?>" width="100" height="100" alt="" title="" data-placeholder="<?php echo $placeholder; ?>"></a>
                  <input type="hidden" name="config_logo" value="<?php echo $config_logo; ?>" id="input-logo">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-email_logo"><?php echo $entry_email_logo; ?></label>
                <div class="col-sm-10"><a href="" id="thumb-email_logo" data-toggle="image" class="img-thumbnail"><img src="<?php echo $email_logo; ?>" width="100" height="100" alt="" title="" data-placeholder="<?php echo $placeholder; ?>"></a>
                  <input type="hidden" name="config_email_logo" value="<?php echo $config_email_logo; ?>" id="input-email_logo">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10"><a href="" id="thumb-icon" data-toggle="image" class="img-thumbnail"><img src="<?php echo $icon; ?>" width="100" height="100" alt="" title="" data-placeholder="<?php echo $placeholder; ?>"></a>
            ...
            <div class="tab-pane" id="tab-cron">
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-cron_secret"><span data-toggle="tooltip" title="<?php echo $help_secret; ?>"><?php echo $entry_secret; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_cron_secret" value="<?php echo $config_cron_secret; ?>" placeholder="<?php echo $entry_secret; ?>" id="input-cron_secret" class="form-control">
                  </div>
                </div>
              </fieldset>
              <fieldset>
                <legend><?php echo $text_recurring_order; ?></legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_combine_transactions; ?>"><?php echo $entry_combine_transactions; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_recurring_order_combine_transactions) { ?>
                      <input type="radio" name="config_recurring_order_combine_transactions" value="1" checked="checked">
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_recurring_order_combine_transactions" value="1">
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_recurring_order_combine_transactions) { ?>
                      <input type="radio" name="config_recurring_order_combine_transactions" value="0" checked="checked">
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_recurring_order_combine_transactions" value="0">
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-recurring_order_max_failed_attempts"><span data-toggle="tooltip" title="<?php echo $help_max_failed_attempts; ?>"><?php echo $entry_max_failed_attempts; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_recurring_order_max_failed_attempts" value="<?php echo $config_recurring_order_max_failed_attempts; ?>" placeholder="<?php echo $entry_max_failed_attempts; ?>" id="input-recurring_order_max_failed_attempts" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-recurring_order_days_before"><span data-toggle="tooltip" title="<?php echo $help_days_before; ?>"><?php echo $entry_days_before; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_recurring_order_days_before" value="<?php echo $config_recurring_order_days_before; ?>" placeholder="<?php echo $entry_days_before; ?>" id="input-recurring_order_days_before" class="form-control">
                  </div>
                </div>
              </fieldset> 
              <fieldset>
                <legend><?php echo $text_free_trial_expiring; ?></legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-free_trial_expiring_days_before"><span data-toggle="tooltip" title="<?php echo $help_free_trial_expiring_days_before; ?>"><?php echo $entry_free_trial_expiring_days_before; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_free_trial_expiring_days_before" value="<?php echo $config_free_trial_expiring_days_before; ?>" placeholder="<?php echo $entry_free_trial_expiring_days_before; ?>" id="input-free_trial_expiring_days_before" class="form-control">
                  </div>
                </div>
              </fieldset>              
            </div>            
