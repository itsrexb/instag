...
class ModelLocalisationCurrency extends Model {
	...
	public function getCurrencies($data = array()) {
		if ($data) {
			$currency_data = $this->cache->get('currency.' . md5(json_encode($data)));
		} else {
		...
		if (!$currency_data) {
			...
			if ($data) {
				$this->cache->set('currency.' . md5(json_encode($data)), $currency_data);
			} else {
