...
class ModelMarketingMarketing extends Model {
	...
	public function getMarketings($data = array()) {
		...
		if (!empty($data['filter_date_added'])) {
			...
			$implode[] = "m.date_added >= '" . $this->db->escape($filter_date_added_start->format('Y-m-d H:i:s')) . "'";
			$implode[] = "m.date_added <= '" . $this->db->escape($filter_date_added_end->format('Y-m-d H:i:s')) . "'";
		}
