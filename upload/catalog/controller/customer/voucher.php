<?php
class ControllerCustomerVoucher extends Controller {
	private $error = array();

	public function index() {
		$data = $this->load->language('customer/voucher');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('customer/voucher/success'));
		}
		...
		$data['action'] = $this->url->link('customer/voucher', '', true);
		...
		$this->response->setOutput($this->load->view('customer/voucher', $data));
	}
