...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$this->document->addStyle('catalog/view/theme/default/dist/css/common.min.css');
		...
		$data['href_dashboard'] = $this->url->link('account/dashboard', '', true);
		$data['href_home']      = $this->url->link('common/home');
		$data['href_forgotten'] = $this->url->link('customer/forgotten', '', true);
		$data['href_history']   = $this->url->link('customer/order', '', true);
		$data['href_logout']    = $this->url->link('customer/logout', '', true);
		$data['href_profile']   = $this->url->link('customer/profile', '', true);
		$data['href_register']  = $this->url->link('customer/register', '', true);
