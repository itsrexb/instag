  ...
  <div style="min-width: 320px; max-width: 680px; margin: 0 auto; text-align: left;">
    ...
    <table style="border-collapse: collapse; width: 100%; margin-bottom: 20px;">
      <tbody>
        ...
        <tr>
          <td style="font-size: 12px; text-align: left; padding: 7px;"><b><?php echo $product_name; ?></b><br />
            &nbsp;<medium> - <?php echo ucwords($account_type); ?>: <?php echo $account_username; ?></medium></td>
        </tr>
        <tr>
          ...
          <a href="<?php echo $href_dashboard; ?>" style="
            ...
            white-space: nowrap;"><?php echo $button_update; ?></a></td>
        </tr>
        <tr>
          <td style="font-size: 12px; text-align: left; padding: 7px;"><?php echo $text_continue; ?></td>
        </tr>      
        <tr>
