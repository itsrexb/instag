...
<div class="boxed-container text-center" id="profile-affiliate">
  <div class="row">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="buttons clearfix">
          <div class="text-center">
            <a href="<?php echo $dashboard; ?>" class="btn btn-primary gold-button back-button"><?php echo $button_back_to_dashboard; ?></a>
            <input class="gold-button" type="submit" value="<?php echo $button_update; ?>" class="btn btn-primary">
          </div>
        </div>
      </form>
